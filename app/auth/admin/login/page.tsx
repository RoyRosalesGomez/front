  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (isLogin) {
        ...
        // ✅ Credenciales correctas - Mostrar confirmación exitosa
        await Swal.fire({
          title: "¡Bienvenido!",
          html: `<p>Acceso concedido</p><p class="text-sm text-gray-600">Redirigiendo al panel de administración...</p>`,
          icon: "success",
          timer: 2000,
      ...
      await Swal.fire({
        title: "¡Registro exitoso!",
        html: '<p>Tu cuenta ha sido creada</p><p class="text-sm text-gray-600">Quedará pendiente hasta que un administrador la active</p>',
        icon: "info",
      ...
      // ❌ Credenciales incorrectas - Mostrar error detallado
      if (msg.includes("Credenciales inválidas") || msg.includes("401")) {
        await Swal.fire({
          ...
          <p class="text-sm text-gray-600 mt-2">Por favor verifica tus credenciales e intenta nuevamente</p>
        `,
          icon: "error",
          confirmButtonColor: "#ef4444",
        ...
        await Swal.fire({
          ...
          text:
            msg || "No se pudo contactar el servidor. Verifica tu conexión.",
          icon: "error",
          confirmButtonColor: "#ef4444",
        });
      }
